                        ...
                        <tr>
                           <td>
                              <select id="category" name="noticeCategory" required>
                                 <option value="COMMON" ${notice.noticeCategory eq 'COMMON' ? 'selected' : '' }>기본
                                 </option>
                                 <option value="NOTICE" ${notice.noticeCategory eq 'NOTICE' ? 'selected' : '' }>공지
                                 </option>
                                 <option value="ESSENTIAL" ${notice.noticeCategory eq 'ESSENTIAL' ? 'selected' : '' }>필독
                                 </option>
                              </select>
                           </td>
                           ...
                           <textarea id="content" name="noticeContent" maxlength="1000" required
                              placeholder="내용">${notice.noticeContent}</textarea>
