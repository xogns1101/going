        ...
        <div class="footer-wrap">
            ...
            <div id="terms-modal" class="modal">
                <div class="modal-content">
                    ...
                    <br>
                    <p>이 약관은 YAGAJA 회사(전자상거래 사업자)가 운영하는 YAGAJA 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과
            ...
            <div id="privacy-modal" class="modal">
                <div class="modal-content">
                    ...
                    <p>또한 YAGAJA는 "개인정보보호정책"을 제정하여 회원들의 개인정보 보호를 위해 최선을 다하겠음을 선언합니다.</p>
                    <p>2. YAGAJA의 "개인정보보호정책"은 관련 법률 및 정부 지침의 변경과 YAGAJA의 내부 방침 변경에 의해 변경될 수 있습니다. </p>
                    <p>YAGAJA의 "개인정보보호방침"이 변경될 경우 변경사항은 YAGAJA 홈페이지의 공지사항에 최소 7일간 게시됩니다. </p>
                    <br><hr>
                    <p>... 이하 생략</p>
