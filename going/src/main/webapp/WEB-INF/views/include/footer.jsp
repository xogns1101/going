    ...
    <footer>
        ...
        <div class="footer-wrap">
            <div class="footer-content">
                <p class="footer-main">
                    YAGAJA &#124; 대표자명 : 박야가자 &#124; 사업자등록번호 : 123-12-1234
        ...
        <div id="terms-modal" class="modal">
            <div class="modal-content">
                ...
                <br>
                <p>이 약관은 YAGAJA 회사(전자상거래 사업자)가 운영하는 YAGAJA 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어
        ...
        <div id="privacy-modal" class="modal">
            <div class="modal-content">
                ...
                <br>
                <p>1. YAGAJA는 "정보통신망이용촉진및정보보호등에관한법률"상의 개인정보보호 규정과 정보통신부가 제정한 "개인정보보호지침" 및 "개인정보의 기술적/관리적 보호조치 기준"을 준수하고
                    있습니다.</p>
        ...
        <div class="moveTopBtn">
            <div class="topBtn"><p>▲</p>TOP</div></div>
