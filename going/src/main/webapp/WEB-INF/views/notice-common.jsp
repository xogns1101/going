  ...
  <section>
    ...
    <div class="notice-list">
      <div class="notice-box">
        ...
        <form action="/main/notice-common" method="get">
          <div class="category-button-box">
            ...
            <button type="submit" class="category-button" style="border: 2px red solid;"><a href="/main/notice-common">기본</a></button>
          </div>
            ...
            <ul class="pagination pagination-lg pagination-custom">
              <c:if test="${maker.page.pageNo != 1}">
                <li class="page-item"><a class="page-link"
                    href="/main/notice-common?pageNo=1&type=${s.type}&keyword=${s.keyword}">&lt;&lt;</a>
                </li>
              </c:if>

              <c:if test="${maker.prev}">
                <li class="page-item"><a class="page-link"
                    href="/main/notice-common?pageNo=${maker.begin-1}&type=${s.type}&keyword=${s.keyword}">&lt;</a>
                </li>
              </c:if>
              ...
              <c:forEach var="i" begin="${maker.begin}" end="${maker.end}">
                <li data-page-num="${i}" class="page-item">
                  <a class="page-link"
                    href="/main/notice-common?pageNo=${i}&type=${s.type}&keyword=${s.keyword}">${i}</a>
                </li>
              </c:forEach>

              <c:if test="${maker.next}">
                <li class="page-item"><a class="page-link"
                    href="/main/notice-common?pageNo=${maker.end+1}&type=${s.type}&keyword=${s.keyword}">&gt;</a>
                </li>
              </c:if>

              <c:if test="${maker.page.pageNo != maker.finalPage}">
                <li class="page-item"><a class="page-link"
                    href="/main/notice-common?pageNo=${maker.finalPage}&type=${s.type}&keyword=${s.keyword}">&gt;&gt;</a>
                </li>
              </c:if>
            </ul>
          </nav>
